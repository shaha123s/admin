  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> transactionUsersRowList = snapshot.data!;

        final transactionUsersRow = transactionUsersRowList.isNotEmpty
            ? transactionUsersRowList.first
            : null;
                                                                              ...
                                                                              Flexible(
                                                                                child: Align(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      listViewTransactionRow.amount!.toString(),
                                                                                ...
                                                                                child: Align(
                                                                                  ...
                                                                                  child: Text(
                                                                                    valueOrDefault<String>(
                                                                                      dateTimeFormat(
                                                                                        "Md",
                                                                                        listViewTransactionRow.createdAt,
