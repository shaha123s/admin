...
class _TransWidgetState extends State<TransWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TransactionRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TransactionRow> transTransactionRowList = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          fit: BoxFit.cover,
                                          image: Image.asset(
                                            'assets/images/Wallet-bro_(1).png',
                                          ).image,
                                        ),
                                      ),
                                    ),
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    if (_model.searchText !=
                                                      ...
                                                      FutureBuilder<
                                                          List<
                                                              VTransactionWithUserRow>>(
                                                        future:
                                                            VTransactionWithUserTable()
                                                                .queryRows(
                                                          queryFn: (q) =>
                                                              q.ilike(
                                                            'full_name',
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<VTransactionWithUserRow>
                                                              listViewVTransactionWithUserRowList =
                                                              snapshot.data!;
                                                          ...
                                                          return ListView
                                                            ...
                                                            itemBuilder: (context,
                                                                listViewIndex) {
                                                              final listViewVTransactionWithUserRow =
                                                                  listViewVTransactionWithUserRowList[
                                                                      listViewIndex];
                                                              return Padding(
                                                                padding: EdgeInsetsDirectional
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              listViewVTransactionWithUserRow.fullName,
                                                                              '__',
                                                                            ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              listViewVTransactionWithUserRow.amount.toString(),
                                                                              '___',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.inter(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                            ...
                                                                            dateTimeFormat(
                                                                              "d/M",
                                                                              listViewVTransactionWithUserRow.createdAt,
