...
class Admin32SupabaseUser extends BaseAuthUser {
  Admin32SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> admin32SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Admin32SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
