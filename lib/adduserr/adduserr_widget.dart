...
import 'adduserr_model.dart';
export 'adduserr_model.dart';

class AdduserrWidget extends StatefulWidget {
  const AdduserrWidget({super.key});

  static String routeName = 'adduserr';
  static String routePath = '/adduserr';

  @override
  State<AdduserrWidget> createState() => _AdduserrWidgetState();
}

class _AdduserrWidgetState extends State<AdduserrWidget> {
  late AdduserrModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdduserrModel());
                                              ...
                                              child: Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .virefypasswordTextController,
                                                      focusNode: _model
                                                          .virefypasswordFocusNode,
                                                      autofocus: false,
                                                      obscureText: !_model
                                                          .virefypasswordVisibility,
                                                      decoration:
                                                          InputDecoration(
                                                        isDense: true,
                                                        labelStyle:
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.passwordTextController.text !=
                                      _model
                                          .virefypasswordTextController.text) {
                                  ...
                                  await UsersTable().insert({
                                    ...
                                    'phon_number': currentPhoneNumber,
                                    'status': 'active',
